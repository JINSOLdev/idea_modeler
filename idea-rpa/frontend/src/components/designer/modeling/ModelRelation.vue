<template>
    <div class="my-1">
        <div v-if="!targetType.includes('If') || 
                (targetType.includes('If') && targetTask.property.conditions.length == 1)"
        >
        ...
        <div v-else>
            ...
            ></v-divider>
            <div class="d-flex">
                <div v-for="(item, idx) in targetTask.property.conditions" 
                        :key="item.type+idx"
                        class="mx-auto"
...
<script lang="ts">
    ...
    export default class ModelRelation extends Vue {
        ...
        @Watch("targetTask.property.conditions", {immediate: true, deep: true})
        setLineWidth() {
