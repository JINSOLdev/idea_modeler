<script lang="ts">
    ...
    export default class SplitStringFromRight extends Mixins(KeywordElement) {
        mounted() {
            this.init();
        }
        ...
        init() {
            ...
            if (!keys || keys.length < 1) {
                ...
                this.$set(this.value.property, "separator", "None")
                this.$set(this.value.property, "max_split", -1)
