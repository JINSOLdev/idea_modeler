    ...
    <div>
        <v-card flat>
            ...
            <v-card-text>
                <path-field
                        :label="'Folder'"
                        :hint="'Path to the folder to archive'"
                        :value.sync="value.property.folder"
                        :required ="true"
                ></path-field>
                
                <variables-field
                        :label="'Archive Name'"
                        :hint="'Filename of the archive'"
            ...
            <v-card-text>
                ...
                <variables-field
                        :label="'Compression'"
                        :hint="'Type of the package compression method (store, deflated, bzip2, lzma)'"
                        :value.sync="value.property.compression"
                ></variables-field>
            </v-card-text>
        </v-card>
    </div>
...
<script lang="ts">
    ...
    export default class ArchiveFolderWithZipPanel extends Mixins(KeywordPanel) {
        mounted() {
            var description = "Create a zip archive of a folder"
